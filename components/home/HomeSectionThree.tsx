      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="p-4 md:p-16 flex flex-col md:max-h-[60vh] items-end mb-4 w-full h-full">
          ...
          <p className="text-base text-red-600 text-right max-w-[55ch] mt-2">
            ...
            electricity? With <span className="font-bold">Load shedding</span>{" "}
            becoming more prevalent. Solar power is now a lot more attractive.
            Besides providing you with a renewable source of electricity, it can
