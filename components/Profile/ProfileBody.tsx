...
function Index() {
  return (
    <div className="flex flex-no-wrap max-w-7xl mx-auto">
      {/* Sidebar starts */}
      {/* Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] */}
      <div className="w-64 absolute sm:relative bg-red-600 shadow md:h-full flex-col justify-between hidden sm:flex rounded-lg mb-3">
        <div className="px-8">
          <div className="h-16 w-full flex items-center">
           <img src="/images/logo-lg.png" className="h-10 object-cover" />
          </div>
          <ul className="mt-12">
            ...
            <li className="flex w-full justify-between text-white hover:text-gray-400 cursor-pointer items-center mb-6">
              <div className="flex items-center">
            ...
            <li className="flex w-full justify-between text-white hover:text-gray-400 cursor-pointer items-center">
              <div className="flex items-center">
      ...
      <div
        className="w-64 z-40 absolute bg-red=600 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out"
        id="mobile-nav"
      >
        <div
        ...
        <div className="px-8 border-t border-gray-700">
          <ul className="w-full flex items-center justify-between bg-red=600">
